...
class AzureProvider(Provider):
    def __init__(self, **config):
        self.base_url = config.get("base_url") or os.getenv("AZURE_OPENAI_ENDPOINT")
    ...
    def chat_completions_create(self, model, messages, **kwargs):
        deployment_name, api_version = model.split(":")
        url = f"{self.base_url}/openai/deployments/{deployment_name}/chat/completions?api-version={api_version}"
